# APISIX Docker Decoupled

This example shows a simple APISIX setup in Docker, using Decoupled deployment mode. In this mode, the control plane and the data plane are placed in separate APISIX Docker containers. APISIX resources are configured by sending HTTP requests to Admin API.
