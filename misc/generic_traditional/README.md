# APISIX Generic Traditional

This example shows some interesting stuff you can do with APISIX Route resource, in Traditional deployment mode (via Admin API).
